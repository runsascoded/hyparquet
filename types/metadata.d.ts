 ...
 */
export function parquetMetadataAsync(asyncBuffer: AsyncBuffer, { parsers, initialFetchSize, suffixStart, geoparquet }?: import("../src/types.d.ts").MetadataAsyncOptions): Promise<FileMetaData>;
/**
